    ...
    <div class="container-fluid">
        <div class="content-container">
            ...
            <div class="header-actions">
                ...
                @if(Request::is('admin/act-logs'))
                    <a href="/admin/recent-logs" class="btn btn-primary">View Recent Logs</a>
                @else
                    <a href="/admin/act-logs" class="btn btn-primary">View All Logs</a>
                @endif

            </div>

            <div class="search-bar">
                <input type="text" id="searchInput" placeholder="🔍 Search activity logs..." onkeyup="searchTable()">
            </div>
            ...
            <div class="table-container">
                <table class="table table-bordered" id="logsTable">
                    <thead>
                        <tr>
                            <th onclick="sortTable(0)">Activity <span class="sort-icon">⬍</span></th>
                            <th onclick="sortTable(1)">Log Date <span class="sort-icon">⬍</span></th>
                        </tr>
                    </thead>
                    <tbody id="tableBody">
                        @foreach($actlogs as $log)
                            ...
                            <tr>
                                <td>{{ $log->log_msg }}</td>
                                <td style="text-align: center;" data-timestamp="{{ \Carbon\Carbon::parse($log->log_date)->timestamp }}">{{ \Carbon\Carbon::parse($log->log_date)->format('Y-m-d g:i:s A') }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
