        ...
        <div class="form-container">
            ...
            <form action="/admin/holidays" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" placeholder="Enter holiday name" required>
                </div>
                ...
                <div class="btn-container">
                    ...
                    data-bs-toggle="modal" data-bs-target="#holidayModal">Add Holiday</button>
                </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-body">
                        Do you confirm that holiday details are correct?
                    </div>
